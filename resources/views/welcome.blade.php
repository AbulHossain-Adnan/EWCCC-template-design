...
<html lang="zxx">
    <head>
        ...
        <link rel="icon" type="image/png" href="assets/images/ewu-logo.png">
        <title>EAST WEAST University</title>

        <!-- PWA  -->
        <meta name="theme-color" content="#6777ef"/>
        <link rel="apple-touch-icon" href="{{ asset('download.png') }}">
                ...
                <div class="container-fluid">
                    <nav class="navbar navbar-expand-md navbar-light">
                        <a class="navbar-brand" href="index.html">
                            <img src="assets/images/ewuc.png" width="50%" alt="logo">
                        </a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-sm-6">
                            <div class="footer-logo-area">
                                <a href="index.html"><img src="assets/images/ewuc.png" alt="Image"></a>
                                <p>Sanu University was established by J.H Merthon in 1810 for the public benefit. Afterwards, it is recognized</p>
                    ...
                    <div class="col-lg-2 col-sm-6">
                        ...
                        <div class="footer-widjet">
                            <h3>Location Map</h3>
                            <div class="list">
                                <!-- <div style="border: 1px solid rgb(240, 233, 236) ; "><a href="index.html"><img src="assets/images/map.png" style="border: 3px solid rgb(187, 177, 184) ;" alt="Image"></a></div> -->
                                <div class="border-outline"><a href="index.html"><img src="assets/images/map.png" alt="Image"></a></div>
                                <p class="text-white" style="margin-top: 10px;">Follow Us :  
                                    <a href="https://www.facebook.com" target="_blank" style="border: 1px solid rgb(187, 177, 177) ;"><i class="ri-facebook-fill"></i></a>
                                    <a href="https://www.twitter.com" target="_blank" style="border: 1px solid rgb(187, 177, 177) ;"><i class="ri-twitter-fill"></i></a>
                                    <a href="https://instagram.com/?lang=en" target="_blank" style="border: 1px solid rgb(187, 177, 177) ;"><i class="ri-instagram-line"></i></a>
                                    <a href="https://linkedin.com/?lang=en" target="_blank" style="border: 1px solid rgb(187, 177, 177) ;"><i class="ri-linkedin-fill"></i></a>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-10 col-md-4">
                            <div class="social-content">
                                <ul>
                                    ...
                                    <li>
                                        <button type="button" class="btn btn-secondary btn-sm btn-responsive btn-block" style="border-radius: 20%";>Apply Online</button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn btn-secondary btn-sm btn-responsive btn-block" style="border-radius: 20%";>Apply Online</button>
                                    </li>
                                    ...
                                    <li>
                                        <button type="button" class="btn btn-secondary btn-sm btn-responsive" style="border-radius: 20%;">Apply Online</button>
                                    </li>
